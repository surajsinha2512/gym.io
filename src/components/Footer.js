function Footer() {
    return (
        <>
            <footer className="flex flex-col justify-center items-center gap-12 p-10 bg-black text-white rounded">
                <nav className="flex gap-4">
                    <a className="cursor-pointer text-lg">About us</a>
                    <a className="cursor-pointer text-lg">Contact</a>
                    <a className="cursor-pointer text-lg">Store</a>
                    <a className="cursor-pointer text-lg">Care</a>
                </nav>
                <nav>
                ...
                <aside>
                    <p>Copyright © 2024 - All right reserved by Gym.</p>
                </aside>
            </footer>
        </>
    )
